...
$plainfuture_text =retrieve_current_list("Germany Family Brick Walls");	
...

{
    ...
    string(7) "User ID"
    [1]=>
    string(11) "WikiTree ID"
    [2]=>
    string(10) "Gender txt"
    [3]=>
    string(8) "FullName"
    [4]=>
    string(14) "Birth Date Txt"
    [5]=>
    string(21) "Birth Date Status Txt"
    [6]=>
    string(14) "Birth Location"
    [7]=>
    string(36) "Birth Location Country, Region, City"
    [8]=>
    string(25) "Birth Location Status txt"
    [9]=>
    string(19) "Birth Date Estimate"
    [10]=>
    string(13) "Birth Century"
    [11]=>
    string(14) "Death Date Txt"
    [12]=>
    string(21) "Death Date Status Txt"
    [13]=>
    string(14) "Death Location"
    [14]=>
    string(36) "Death Location Country, Region, City"
    [15]=>
    string(25) "Death Location Status txt"
    [16]=>
    string(11) "Privacy txt"
    [17]=>
    string(9) "Is Locked"
    [18]=>
    string(14) "All Categories"
    [19]=>
    string(13) "All Templates"
    [20]=>
    string(12) "All Managers"
    [21]=>
    string(12) "Guest Orphan"
    [22]=>
    string(16) "Project Managers"
    [23]=>
    string(6) "TreeID"
  }	*/
	$index_wikitree_id = 1;
		...
		if(isset($row[$index_wikitree_id]) && $row[$index_wikitree_id] != "" && $row[$index_wikitree_id]!="WikiTree ID")
		{
			...
			if(isset($row[$index_categories]) && trim($row[$index_categories]) != "" && $row[$index_categories]!="All Categories")
			{
				$categories = explode("\r\n", $row[$index_categories]);
				 // echo "<pre>". var_dump($row[$index_categories]) . "</pre>";
				...
				// $categories_in_a_line = implode("; ", $categories);
			}
			// echo $categories_in_a_line;
