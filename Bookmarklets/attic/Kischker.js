...
function removeCrap(date, place)
{
	...
	if(year_str != null && year_str.length ==4)
	{
		...
		if(year < 1921)
		{
			placeBetter = placeBetter.replace("Bačko Dobro Polje (Kischker/Kisker)", "Kischker, Batsch-Bodrog, Ungarn");
			placeBetter = placeBetter.replace("Bačko Dobro Polje (Kischker,Kisker)", "Kischker, Batsch-Bodrog, Ungarn");
			placeBetter = placeBetter.replace("Altker (Zmajevo, Serbia)", "Altker, Batsch-Bodrog, Ungarn");

		}
		else
		{
			placeBetter = placeBetter.replace("Bačko Dobro Polje (Kischker/Kisker)", "Kischker, Vojvodina, Serbien");
			placeBetter = placeBetter.replace("Bačko Dobro Polje (Kischker,Kisker)", "Kischker, Vojvodina, Serbien");
			placeBetter = placeBetter.replace("Altker (Zmajevo, Serbia)", "Altker, Vojvodina, Serbien");
		}
	}
	return placeBetter;
}
