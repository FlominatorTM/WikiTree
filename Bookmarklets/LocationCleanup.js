...
birtDate =  document.getElementById('mBirthDate');
birthLocation.value = removeCrap(birtDate.value, birthLocation.value);
...
/* throws exception when called from edit profile, 
but doesn't matter since everything was done already then*/
